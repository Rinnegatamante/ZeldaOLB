...
rebond(false), element(FEU) {
    ...
    switch (id) {
        case 1 : // boule de feu petite
            ...
            image = IMG_Load("app0:/images/objet/projectiles2.png");
            break;
        case 2 : // boule de feu petite droite
            if (angly!=0) {h=16;w=7;}
            if (anglx!=0) {h=7;w=16;}
            force=4; max=1;
            image = IMG_Load("app0:/images/objet/projectiles3.png");
            break;
        case 3 : // arc magique
            if (angly!=0) {h=8;w=16;}
            if (anglx!=0) {h=16;w=8;}
            force=4; max=1; renvoyable=true; element=ENNEMI;
            image = IMG_Load("app0:/images/objet/projectiles4.png");
            break;
        case 4 : // boulet
            w=8; h=13; force=2; element=PROJECTILE;
            image = IMG_Load("app0:/images/objet/projectiles5.png");
            break;
        case 5 : // boule magique
            w=16; h=16; force=7; renvoyable=true; element=ENNEMI; max=1;
            image = IMG_Load("app0:/images/objet/projectiles6.png");
            break;
        case 6 : // eclair
            w=83; h=148; force=9; element=ENNEMI; max=4; anglx=0; angly=0;
            image = IMG_Load("app0:/images/objet/projectiles8.png");
            break;
        case 7 : // lapin
            w=22; h=22; force=0; element=LAPIN; max=1;
            image = IMG_Load("app0:/images/objet/projectiles7.png");
            break;
        case 8 : // boule de feu violette
            w=7; h=7; force=0; renvoyable=true; element=DEMI;
            image = IMG_Load("app0:/images/objet/projectiles9.png");
            break;
        case 9 : // boule de feu bleue
            w=7; h=7; force=0; renvoyable=true; element=COLERE;
            image = IMG_Load("app0:/images/objet/projectiles10.png");
            break;
        ...
        case 11 : // boule de glace grosse
            ...
            image = IMG_Load("app0:/images/objet/projectiles11.png");
            break;
        case 12 : // boule de feu verte
            w=7; h=7; force=0; renvoyable=true; element=MORTEL;
            image = IMG_Load("app0:/images/objet/projectiles12.png");
            break;
    }
