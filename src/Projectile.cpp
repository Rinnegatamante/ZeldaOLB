...
void Projectile::changeType(int type) {
    ...
    switch (type) {
        ...
        case 2 : //flèche argent
            if (id == 1) image = IMG_Load("app0:/images/objet/projectiles.png"); 
            else image = IMG_Load("app0:/images/objet/projectilesarg.png"); 
            w=16; h=16;
            if (direction == N || direction == S) {zx=4; zy=0; zw=7; zh=16;} 
            else {zx=0; zy=4; zw=16; zh=7;}
            break;
        case 3 : //grappin
            image = IMG_Load("app0:/images/objet/grappin.png");
            w=12; h=12;
            ...
            break;
        case 4 : //bombe
            image = IMG_Load("app0:/images/objet/bombe.png");
            w=16; h=16;
        ...
        case 6 : //baguette de glace
            image = IMG_Load("app0:/images/objet/magie.png");
            w=17; h=17;
            zx=0; zy=0; zw=17; zh=17;
            break;
        case 7 : //flamme
            image = IMG_Load("app0:/images/objet/feu.png");
            w=16; h=16;
            zx=0; zy=0; zw=16; zh=16;
            max=5;
            break;
        case 8 : //plouf
            image = IMG_Load("app0:/images/objet/plouf.png");
            w=16; h=16;
            zx=0; zy=0; zw=16; zh=16;
            vanim=40;
            max=3;
        ...
        case 11 :
        case 12 :
            image = IMG_Load("app0:/images/objet/buisson.png");
            w=27; h=43;
        ...
        case 15 : //explosion fumée blanche
            image = IMG_Load("app0:/images/ennemi/explo.png");
            w=28; h=28;
            zx=0; zy=0; zw=w; zh=h;
            max=6; vanim=60;
            break;
        case 16 : //explosion fumée rose
            image = IMG_Load("app0:/images/link/exploLapin.png");
            w=28; h=28;
            zx=0; zy=0; zw=w; zh=h;
            max=3; vanim=60;
            break;
        case 17 : //explosion fumée viloette
            image = IMG_Load("app0:/images/link/exploOni.png");
            w=28; h=28;
            zx=0; zy=0; zw=w; zh=h;
            max=3; vanim=60;
            break;
        case 19 : //explosion glace
            image = IMG_Load("app0:/images/link/gel.png");
            w=42; h=36;
            zx=0; zy=0; zw=w; zh=h;
            max=0; vanim=120;
            break;
        case 20 : //explosion sang
            image = IMG_Load("app0:/images/link/splash.png");
            w=32; h=32;
            zx=0; zy=0; zw=w; zh=h;
            max=4; vanim=120;
            break;
        ...
        case 25 :
        case 26 :
            image = IMG_Load("app0:/images/link/objets.png");
            w=16; h=16;
            zx=0; zy=0; zw=16; zh=16;
            chmax=64;
