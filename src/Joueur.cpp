...
void Joueur::save() {
    ...
    ostringstream im;
    im << numSave;
    ofstream f(("ux0:/data/ZeldaOLB/olb" + im.str() + ".dat").c_str(),ios::out | ios::binary);
...
void Joueur::load() {
    ...
    ostringstream im;
    im << numSave;
    ifstream f(("ux0:/data/ZeldaOLB/olb" + im.str() + ".dat").c_str(),ios::in | ios::binary);
    if(!f.is_open()) return;
...
void Joueur::draw(SDL_Surface* gpScreen) {
    ...
    if (!getOnilink() && getAvancement()==16) {
        if(imageTmp) SDL_FreeSurface(imageTmp);
		imageTmp = IMG_Load("app0:/images/ennemi/ennemi75.png");
...
void Joueur::setBouclier(int b) {
    ...
    if (oni) {
        ...
        else boucl = new Bouclier(IMG_Load("app0:/images/link/bouclierOni.png"), 10);
    }
    else boucl = new Bouclier(IMG_Load(("app0:/images/link/bouclier" + im.str() + ".png").c_str()), bouclier);
}
...
void Joueur::setTunique(int t) {
    ...
    std::ostringstream im;
    im << tunique;
    if (oni) image = IMG_Load("app0:/images/link/onilink.png");
    else image = IMG_Load(("app0:/images/link/link" + im.str() + ".png").c_str());
...
void Joueur::setEpee(int e) {
    ...
    im << epee;
    if (oni) {
        if (hasObjet(O_MASQUE)==2) imageEpee = IMG_Load("app0:/images/link/epeeOni2.png");
        else imageEpee = IMG_Load("app0:/images/link/epeeOni.png");
    }
    else imageEpee = IMG_Load(("app0:/images/link/epee" + im.str() + ".png").c_str());
