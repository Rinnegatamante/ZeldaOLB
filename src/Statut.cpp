...
valjauge2(0), maxjauge2(10), nivjauge2(60), dec(0) {
    ...
    imageStatut = IMG_Load("app0:/images/statut/statut.png");
    imageChiffre = IMG_Load("app0:/images/statut/chiffres.png");
    imageInventaire = IMG_Load("app0:/images/statut/inventaire.png");
